...
class LadiesDetail : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        userFriend = dictionary["userFriend"] as? String
    ...
    func toDictionary() -> [String:Any]
    {
        ...
        if userFriend != nil{
            dictionary["userFriend"] = userFriend
        }
        if videoChat != nil{
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        userFriend = aDecoder.decodeObject(forKey: "userFriend") as? String
    ...
    @objc func encode(with aCoder: NSCoder)
    {
        ...
        if userFriend != nil{
            aCoder.encode(userFriend, forKey: "userFriend")
        }
        if videoChat != nil{
