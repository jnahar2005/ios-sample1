...
public class SpaceView {
    ...
    func show() {
        ...
        mWindow?.windowLevel = UIWindow.Level.statusBar
        mWindow?.isHidden = false
        mWindow?.makeKeyAndVisible()
        mWindow?.windowLevel = (UIWindow.Level.statusBar + 1)
        if spaceView == nil {
    ...
    private func makeContent() -> UIView {
        ...
        if spaceStyle != nil {
            switch spaceStyle! {
                ...
                case .error:
                    contentView.backgroundColor = UIColor(red: 52.0/255.0, green: 109.0/255.0, blue: 148.0/255.0, alpha: 0.98)
                case .warning:
        ...
        if image != nil {
            ...
            let imageCenterY = NSLayoutConstraint(item: imageView!, attribute: NSLayoutConstraint.Attribute.centerY, relatedBy: NSLayoutConstraint.Relation.equal, toItem: contentView, attribute: NSLayoutConstraint.Attribute.centerY, multiplier: 1, constant: 0)
            let imageLeading = NSLayoutConstraint(item: imageView!, attribute: NSLayoutConstraint.Attribute.leading, relatedBy: NSLayoutConstraint.Relation.equal, toItem: contentView, attribute: NSLayoutConstraint.Attribute.leading, multiplier: 1, constant: 8)
            let imageHeight = NSLayoutConstraint(item: imageView!, attribute: NSLayoutConstraint.Attribute.height, relatedBy: NSLayoutConstraint.Relation.equal, toItem: nil, attribute: NSLayoutConstraint.Attribute.notAnAttribute, multiplier: 1, constant: 35)
            let imageWidth = NSLayoutConstraint(item: imageView!, attribute: NSLayoutConstraint.Attribute.width, relatedBy: NSLayoutConstraint.Relation.equal, toItem: nil, attribute: NSLayoutConstraint.Attribute.notAnAttribute, multiplier: 1, constant: 35)
        ...
        let titleCenterY = NSLayoutConstraint(item: titleView, attribute: NSLayoutConstraint.Attribute.centerY, relatedBy: NSLayoutConstraint.Relation.equal, toItem: contentView, attribute: NSLayoutConstraint.Attribute.centerY, multiplier: 1, constant: 0)
        var titleLeading = NSLayoutConstraint(item: titleView, attribute: NSLayoutConstraint.Attribute.leading, relatedBy: NSLayoutConstraint.Relation.equal, toItem: contentView, attribute: NSLayoutConstraint.Attribute.leading, multiplier: 1, constant: 16)
        let titleTrailing = NSLayoutConstraint(item: titleView, attribute: NSLayoutConstraint.Attribute.trailing, relatedBy: NSLayoutConstraint.Relation.equal, toItem: contentView, attribute: NSLayoutConstraint.Attribute.trailing, multiplier: 1, constant: -16)
        
        if let imgView = imageView {
            titleLeading = NSLayoutConstraint(item: titleView, attribute: NSLayoutConstraint.Attribute.leading, relatedBy: NSLayoutConstraint.Relation.equal, toItem: imgView, attribute: NSLayoutConstraint.Attribute.trailing, multiplier: 1, constant: 8)
        }
        ...
        if !spaceDescription.isEmpty {
            ...
            let titleTop = NSLayoutConstraint(item: titleView, attribute: NSLayoutConstraint.Attribute.top, relatedBy: NSLayoutConstraint.Relation.equal, toItem: contentView, attribute: NSLayoutConstraint.Attribute.top, multiplier: 1, constant: 7)

            let descrTop = NSLayoutConstraint(item: descriptionView, attribute: NSLayoutConstraint.Attribute.top, relatedBy: NSLayoutConstraint.Relation.lessThanOrEqual, toItem: titleView, attribute: NSLayoutConstraint.Attribute.bottom, multiplier: 1, constant: 8)
            let descBot = NSLayoutConstraint(item: descriptionView, attribute: NSLayoutConstraint.Attribute.bottom, relatedBy: NSLayoutConstraint.Relation.lessThanOrEqual, toItem: contentView, attribute: NSLayoutConstraint.Attribute.bottom, multiplier: 1, constant: -8)
            var descLeading = NSLayoutConstraint(item: descriptionView, attribute: NSLayoutConstraint.Attribute.leading, relatedBy: NSLayoutConstraint.Relation.equal, toItem: contentView, attribute: NSLayoutConstraint.Attribute.leading, multiplier: 1, constant: 16)
            let descTrailing = NSLayoutConstraint(item: descriptionView, attribute: NSLayoutConstraint.Attribute.trailing, relatedBy: NSLayoutConstraint.Relation.equal, toItem: contentView, attribute: NSLayoutConstraint.Attribute.trailing, multiplier: 1, constant: -16)
            if let imgView = imageView {
                descLeading = NSLayoutConstraint(item: descriptionView, attribute: NSLayoutConstraint.Attribute.leading, relatedBy: NSLayoutConstraint.Relation.equal, toItem: imgView, attribute: NSLayoutConstraint.Attribute.trailing, multiplier: 1, constant: 16)
            }
...
extension UIViewController {
    ...
    public func MethodForErrorShow()  {
        showSpace(title: spaceTitle, description: spaceDescr, spaceOptions: [
