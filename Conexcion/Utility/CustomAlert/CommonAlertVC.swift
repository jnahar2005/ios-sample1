...
class CommonAlertVC: UIViewController {
    ...
    @IBOutlet weak var logoAlert: UIButton!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        buttonOkay.addCornerRadiusWithShadow(color: .black, borderColor: .clear, cornerRadius: 25)
       // buttonCancel.setCornerRadiusWith(radius: 25, borderWidth: 1.0, borderColor: #colorLiteral(red: 0.03529411765, green: 0.2274509804, blue: 0.9333333333, alpha: 1))
        buttonCancel.addCornerRadiusWithShadow(color: .black, borderColor: .clear, cornerRadius: 25)
        logoAlert.addCornerRadiusWithShadow(color: .black, borderColor: .clear, cornerRadius: 30)
        logoAlert.clipsToBounds = true
